...
def chat_stream_raw(
    ...
    **kwargs,
    ...
    stop_words_ids.extend(qwen_generation_utils.get_stop_words_ids(generation_config.chat_format, tokenizer))
    ...
    for token in self.generate_stream(
        ...
        **kwargs,
        ...
        last_response = tokenizer.decode(outputs, skip_special_tokens=True, errors="ignore")
